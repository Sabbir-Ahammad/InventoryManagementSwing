 ...
 * @author sabbir
 */
public class ReportApp extends javax.swing.JFrame {

    /**
     * Creates new form ReportApp
     */
    public ReportApp() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
